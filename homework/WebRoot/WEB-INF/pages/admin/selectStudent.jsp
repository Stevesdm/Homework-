						...
						<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
								  <div class="panel panel-default">
									...
									<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
									  <div class="panel-body">
											<form role="form" action="admin/selectStudentBysno" method="post">
								  ...
								  <div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
									  <div class="panel-body">
											<form role="form" action="admin/selectStudentByMajorClass" method="post">
													<div class="form-group">
														<label>选择专业</label>													
													...
													<table class="table table-striped table-bordered table-hover">
														...
														<c:forEach items="${student}" var="s">
															<tr>
																<td>${s.sno }</td>
																<td>${s.sname }</td>
																<td>${s.smajor}${s.sclass}</td>
																<td><a href="admin/updateStudent?sno=${s.sno}" class="btn btn-info btn-xs " role="button">修改</a>|
																	<a href="admin/deleteStudent?sid=${s.sid}" class="btn btn-danger btn-xs" role="button">删除</a>
																</td>
															</tr>
														</c:forEach>
														</tbody>
