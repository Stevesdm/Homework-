            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">学生作业管理 </h1>
								  ...
								  <div class="panel panel-default">
									...
									<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
									  <div class="panel-body">
											<form role="form" action="admin/ManageHomework" method="post">
													...
													<table class="table table-striped table-bordered table-hover">
														...
														<c:forEach items="${list}" var="sc">
															<tr>
																...
																<td>${sc.scfilename}</td>
																<td>
																	<a href="admin/deleteHomework?sc_id=${sc.sc_id}&sno=${sc.sno}" class="btn btn-danger btn-xs" role="button">删除</a>
																</td>
															</tr>
														</c:forEach>
														</tbody>
