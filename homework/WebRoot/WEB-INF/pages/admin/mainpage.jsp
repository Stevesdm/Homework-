            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">工大风景</h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                <div id="port-folio">
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="portfolio-item awesome mix_all" data-cat="awesome" >
                        ...
                        <img src="<%=basePath%>/img/portfolio/03.jpg" class="img-responsive " alt="" />
                        <div class="overlay">
                            <p>
                                <span>
								工大风景
                            ...
                            <a class="preview btn btn-info " title="" href="<%=basePath%>/img/portfolio/03.jpg"><i class="fa fa-plus fa-2x"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 ">
                    ...
                    <div class="portfolio-item landscape mix_all" data-cat="landscape" >
                        ...
                        <img src="<%=basePath%>/img/portfolio/04.jpg" class="img-responsive " alt="" />
                        <div class="overlay">
                            <p>
                                <span>
                        		       工大风景
                            ...
                            <a class="preview btn btn-info" title="" href="<%=basePath%>/img/portfolio/04.jpg"><i class="fa fa-plus fa-2x"></i></a>
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="portfolio-item nature mix_all" data-cat="nature" >
                        ...
                        <img src="<%=basePath%>/img/portfolio/05.jpg" class="img-responsive " alt="" />
                        <div class="overlay">
                          <p>
                                <span>
                             		   工大风景
                            ...
                            <a class="preview btn btn-info" title="" href="<%=basePath%>/img/portfolio/05.jpg"><i class="fa fa-plus fa-2x"></i></a>
            ...
            <div class="row " style="padding-top: 50px;">
                <div class="col-md-4 ">
                    ...
                    <div  class="portfolio-item nature mix_all" data-cat="nature" >
                        ...
                        <img src="<%=basePath%>/img/portfolio/06.jpg" class="img-responsive " alt="" />
                        <div class="overlay">
                           <p>
                                <span>
                              		  工大风景
                            ...
                            <a class="preview btn btn-info " title="" href="<%=basePath%>/img/portfolio/06.jpg"><i class="fa fa-plus fa-2x"></i></a>
                ...
                <div class="col-md-4 ">
                    ...
                    <div  class="portfolio-item nature mix_all" data-cat="nature" >
                        ...
                        <img src="<%=basePath%>/img/portfolio/07.jpg" class="img-responsive " alt="" />
                        <div class="overlay">
                            <p>
                                <span>
                               		工大风景
                            ...
                            <a class="preview btn btn-info" title="" href="<%=basePath%>/img/portfolio/07.jpg"><i class="fa fa-plus fa-2x"></i></a>
                ...
                <div class="col-md-4 ">
                    ...
                    <div  class="portfolio-item nature mix_all" data-cat="nature" >
                        ...
                        <img src="<%=basePath%>/img/portfolio/08.jpg" class="img-responsive " alt="" />
                        <div class="overlay">
                          <p>
                                <span>
									工大风景
                            ...
                            <a class="preview btn btn-info" title="" href="<%=basePath%>/img/portfolio/08.jpg"><i class="fa fa-plus fa-2x"></i></a>
