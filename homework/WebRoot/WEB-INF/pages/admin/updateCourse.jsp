            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">课程管理 </h1>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <form role="form" action="admin/UpdateCourse" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>课程号</label>
                                            <input class="form-control" type="text" name="cno" value="${course.cno}" readonly="readonly">
                                        </div>
										<div class="form-group">
                                            <label>课程名</label>
										...
										<div class="form-group">
											<label>授课教师</label>
											  <select multiple class="form-control" name="tno"> 
												<c:forEach items="${list}" var="t">
													<option value="${t.tno}">${t.tno}---${t.tname}</option> 
												</c:forEach>
											  </select>
										</div>
										
                                        <button type="submit" class="btn btn-info">修改课程</button>
                                </form>
                            </div>
                        </div>
                        </div>
