...
<body>
			...
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						...
						<h1 class="page-subhead-line">设置学生课程</h1>
				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="panel panel-info">
							<div class="panel-group" id="accordion" role="tablist"
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse"
										...
										<div class="panel-body">
											<form role="form" action="admin/addMajorGradeClass"
												method="post">
												<div class="form-group">
													<label>输入专业</label> 
													<input class="form-control" type="text" name="smajor">
												</div>

												<div class="form-group">
													<label>输入年级</label> 
													<input class="form-control" type="text" name="sgrade">
												</div>
								...
								<div class="panel panel-default">
									<div class="panel-heading" role="tab" id="headingOne">
										<h4 class="panel-title">
											<a role="button" data-toggle="collapse"
												...
												aria-expanded="true" aria-controls="collapseOne"> 设置学生课程
											</a>
										</h4>
									</div>
									<div id="collapseOne" class="panel-collapse collapse"
										...
										<div class="panel-body">
											<form role="form" action="admin/addSetCourse" method="post">
												<div class="form-group">
													<label>选择专业</label> <select multiple class="form-control"
														name="smajor">
														<c:forEach items="${majorList }" var="majorList">
															<option value="${majorList.smajor}">${majorList.smajor}</option>
														</c:forEach>
													</select>
												</div>
												
												<div class="form-group">
													<label>选择年级</label> <select multiple class="form-control"
														name="sgrade">
														<c:forEach items="${gradeList }" var="gradeList">
															<option value="${gradeList.sgrade}">${gradeList.sgrade}</option>
														</c:forEach>
													</select>
												</div>
												...
												<div class="form-group">
													<label>选择班级</label> <select multiple class="form-control"
														name="sclass">
														<c:forEach items="${classList }" var="classList">
															<option value="${classList.sclass}">${classList.sclass}</option>
														</c:forEach>
													</select>
												</div>

												<div class="form-group">
													<label>选择课程号</label> <select multiple class="form-control"
														name="cno">
														<c:forEach items="${CnoList }" var="CnoList">
															<option value="${CnoList.cno}">${CnoList.cno}---${CnoList.cname }</option>
														</c:forEach>
													</select>
												</div>
							...
							<div class="panel-heading">设置学生课程</div>
							<div class="panel-body">
														...
														<tbody>
															<c:forEach items="${list }" var="list">
																<tr>
																	...
																	<td>${list.sclass }</td>
																	<td>${list.cno}</td>
																	<td><a href="admin/deleteSetCourse?id=${list.id}"
																		class="btn btn-info btn-xs" role="button">删除</a></td>
																</tr>
															</c:forEach>
														</tbody>
													</table>
	...
	<!--footer-->
	<div id="footer-sec">Copyright &copy; 2016.沈阳工业大学All rights
		reserved.</div>
	<!-- /. FOOTER  -->
