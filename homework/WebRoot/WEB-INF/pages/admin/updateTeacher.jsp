            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <form role="form" action="admin/UpdateTeacher" method="post">
                                        <div class="form-group">
                                            <label>教师编号</label>
                                            <input class="form-control" type="text"  name="tno" value="${teacher.tno}" readonly="readonly">
                                        </div>
										<div class="form-group">
                                            <label>姓名</label>
                                            <input class="form-control" type="text" name="tname" value="${teacher.tname}">
                                        </div>
