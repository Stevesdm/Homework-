						...
						<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
								  <div class="panel panel-default">
									...
									<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
									  <div class="panel-body">
											<form role="form" action="admin/selectCourseBycno" method="post">
								  ...
								  <div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
									  <div class="panel-body">
											<form role="form" action="admin/selectCourseByname" method="post">
													<div class="form-group">
														<label>课程名</label>													
													...
													<table class="table table-striped table-bordered table-hover">
														...
														<tbody>
															...
															<tr>
																<td>${c.cno}</td>
																<td>${c.cname}</td>
																<td><a href="admin/updateCourse?cno=${c.cno }" class="btn btn-info btn-xs " role="button">修改</a>|
																	<a href="admin/deleteCourse?cid=${c.cid}" class="btn btn-danger btn-xs" role="button">删除</a>
																</td>
															</tr>
															</c:forEach>
														</tbody>
