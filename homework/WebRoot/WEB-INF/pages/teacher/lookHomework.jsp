		...
		<div class="container" ">
			<div style="display:block;clear:both;">
				...
				<div class="content_right" style="height:750px" >
					<div  style="margin:5px;height:415px;font-size:14;width:100%;">
						...
						<button class="btn btn-primary btn-xs"  style="float:right;">下载所选作业</button>
								...
								<tbody>
								  ...
								  <c:forEach   items="${sclist}" var="s">
									<tr style="overflow:hidden;text-overflow:ellipsis;">
										...
										<th style="width: 14%;">${s.sno }</th>
										<th style="width: 15%;">${s.sno }</th>
										<th style="width: 15%;">${s.cno }</th>
										<th style="width: 10%;">${s.sctimes }</th>
										<th style="width: 30%;">${s.scfile }</th>
										<th style="width: 8%;">
											<a href="teacher/comment?sno=${s.sno }&cno=${s.cno }&sctimes=${s.sctimes }&id=${id}"><img src="./img/comment.jpg" style="width:20px;height:20px"></a>
										</th>
										<th style="width: 8%;">
											<a href=""><img src="./img/download1.jpg" style="width:20px;height:20px"></a>
										</th>	
									</tr>
								  </c:forEach>	
								  </form>
