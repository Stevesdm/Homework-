			...
			<div style="display:block;clear:both;">
				...
				<div style="width:100%;border:1px solid #edf1f2;background-color:#fff;float:left;margin-top:30px;margin-bottom:50px;">
					<div style="padding:10px 50px 40px;" class="us">
						<p style="font-size:18px;line-height:49px;margin-bottom:2.1em;border-bottom:1px solid #eceff0;color:#363d40;">我们的课程</p>
						<!-- 课程列表 -->
						<c:forEach items="${courseList}" var="course">
							<div class="course-list-div">
								<center><h3>${course.cname}</h3></center>
								<img src="./img/course/${course.cimage }" >
								 <a href="teacher/lookHomework/${course.cno}"><button type="button" class="btn btn-primary btn-lg">进入课程</button></a>
							</div>
						</c:forEach>
