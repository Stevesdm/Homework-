	...
	<script type="text/javascript">
 	function judgepassword(){
  	   ...
  	   if(d.length<6){
  		   ...
  		   alert("两次输入的密码不一致");
  		   document.getElementById("pw2").select();
  		    return false;
       }else{
    	    document.repeatPwd.submit();
    	}
 	}
</script>
			...
			<div style="display:block;clear:both;">
				...
				<div style="width:100%;border:1px solid #edf1f2;background-color:#fff;float:left;margin-top:30px;margin-bottom:50px;">
					<div style="padding:10px 50px 40px;" class="us">
						<p style="font-size:18px;line-height:49px;margin-bottom:2.1em;border-bottom:1px solid #eceff0;color:#363d40;">修改密码</p>
						<!-- 修改密码 -->
						<div style="height:620px;">
						<center>
							
							<form action="student/changepwd" method="post" name="repeatPwd">
							  <div class="form-group">
							    <label for="exampleInputEmail1">新密码</label>
							    <input type="password" class="form-control" id="password1" name="password1" placeholder="新密码，长度在6-15位之间">
							  </div>
							  <div class="form-group">
							    <label for="exampleInputPassword1">重复密码</label>
							    <input type="password" class="form-control" id="password2" name="password2" placeholder="重复新密码">
							  </div>
							  <button onclick="judgepassword()" class="btn btn-default">修改</button>
							</form>
						...
						<center>
							<img src="./img/sutview/sut.jpg" width="600" height="400">
						</center>
						</div>
					</div>
				</div>	
