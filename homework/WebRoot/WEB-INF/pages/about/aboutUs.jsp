	...
	<body  style="background-color:#e5e5e5;">
		...
		<div class="container" ">
			<div style="display:block;clear:both;">
				...
				<!-- 右半部分 -->
				<div style="width:74%;border:1px solid #edf1f2;background-color:#fff;float:left;margin-top:30px;margin-left:25px;margin-bottom:50px;">
					<div style="padding:10px 50px 40px;" class="us">
						<p style="font-size:18px;line-height:49px;margin-bottom:2.1em;border-bottom:1px solid #eceff0;color:#363d40;">关于我们</p>
