...
-->
	...
	<body  style="background-color:#e5e5e5;">
			...
			<div style="display:block;clear:both;">
				...
				<div style="width:74%;border:1px solid #edf1f2;background-color:#fff;float:left;margin-top:30px;margin-left:25px;">
					<div style="padding:10px 50px 40px;" class="us">
						<p style="font-size:18px;line-height:49px;margin-bottom:2.1em;border-bottom:1px solid #eceff0;color:#363d40;">团队介绍</p>
		...
		<div id="regDiv" style="background-color:white;width:350px;height:330px;z-index:2;display:none;position:absolute;border-top:none;">
		    <div onmousedown="titleMove()" id="reg_title" style="width:auto;height:45px;background-color:white;border:1px solid silver;border-left:none;border-right:none;border-top:none;margin:0px 15px 3px 15px;">
					<div style="float: left;">
						<h3>注册</h3>
					</div>
					<a href="javascript:hidReg()" style="float:right;text-decoration:none;color:black;margin-right:2px;font-size:20px"><h3>&times;</h3></a>
		    </div>
		    <div style="clear:right;width:auto;height:270px;margin:20px 15px 0px 15px;">
				<form action="reg" method="post" name="regform">
					<div class="form-group">
							<input type="text" placeholder="请输入电子邮箱" class="form-control" name="email"/>
					</div>	
					<div class="form-group">
							<input type="password" placeholder="请输入密码" class="form-control" name="password"/>
					</div>
					<div class="form-group">
							<input type="text" placeholder="请输入昵称" class="form-control" name="username"/>
					</div>	
					<div class="form-group">
							<button type="button" class="btn btn-danger btn-block" onclick="regModel()">注册</button>
					</div>	
				</form>
		    </div>
		</div>
