			...
			<div style="display:block;clear:both;">
				...
				<div style="width:74%;border:1px solid #edf1f2;background-color:#fff;float:left;margin-top:30px;margin-left:25px;">
					<div style="padding:10px 50px 40px;" class="us">
						<p style="font-size:18px;line-height:49px;margin-bottom:2.1em;border-bottom:1px solid #eceff0;color:#363d40;">意见反馈</p>
						<div style="padding:5px 30px 10px;">
							<form action="" method="post">
								<div class="form-group">
									<textarea name="" class="form-control" rows="15" placeholder="少年，哪里不爽尽情的来喷吧"></textarea>
								</div>
								<div class="form-group">
									<input type="text" class="form-control" placeholder="请留下真实联系方式，方便我们进行答疑">
								</div>
								<div class="form-group">
